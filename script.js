document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderWebsitesByCategory(sitesToRender = websites) {
        ...
        // Initialize tabs scrolling for mobile
...
// Add this new function for horizontal tab scrolling on mobile
function initMobileTabsScroll() {
    const tabContainer = document.querySelector('.tab-container');
    if (tabContainer && window.innerWidth <= 768) {
        // Make sure tab navigation is scrollable on mobile
...
// Add window resize event for responsiveness
